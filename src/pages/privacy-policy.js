	...
	return (
		<div>
			<div className="p-6 m-4">
				<button
					className="float-right px-4 py-2 text-white bg-green-600 rounded-lg"
					onClick={() => navigate("/")}
				>
					Regresar
				</button>
				<h1 className="text-2xl text-center">Política de privacidad</h1>

				<p>POLÍTICA DE PRIVACIDAD</p>

				<p>
					El presente Política de Privacidad establece los términos en que
					begoba usa y protege la información que es proporcionada por sus
				...
				<p>
					...
					proporcione y podrán ser cancelados en cualquier momento. Begoba está
				...
				<p>
					...
					quiera y la proporcione directamente, visitas una web. Usted puede
				...
				<p>
					Begoba Se reserva el derecho de cambiar los términos de la presente
