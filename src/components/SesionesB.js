    ...
    <div className="mx-10">
      <div className="flex justify-center px-2 mt-10 lg:px-20 text-primary">
        <p className="text-xl text-center lg:text-2xl text-primary">
          Si eres Nutriologo, Psicologo o Profesional de la Salud, te invito al
          taller CONSIGUE PACIENTES EN REDES SOCIALES !Quedan pocos lugares!
