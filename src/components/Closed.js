	...
	return (
		<>
			<div className="pb-8 bg-primary">
				...
				<h1 className="px-5 mx-4 mb-8 text-lg font-semibold text-center text-white lg:text-3xl lg:mx-10 lg:my-12">
					Incrementa tu consulta es un entrenamiento que le ha servido a
					psicólogos, nutriólogoss y profesionales de la salud a incrementar su
				...
				<div className="grid gap-4 mx-4 mt-6 lg:grid-cols-2">
					<div className="mx-4 md:mx-14">
						<h1 className="px-5 mx-4 font-semibold text-center text-white text-md lg:text-2xl lg:mx-10">
			...
			<div className="my-8">
				<h1 className="pb-8 text-xl font-semibold text-center lg:text-3xl text-secondary">
